...
class BipartiteWord2Vec():
    def __init__ (self, corpus, left_part, right_part,
                  d=10, learning_rate=0.001, epochs=5000,
        ...
        for ep in range(0, self.epochs):
            ...
            for sentence in self.corpus:
                ...
                for i, word in enumerate(sentence):
                    ...
                    #######   SPECIFIC to bipartite assumption
                    if word in self.left_part:
                        negative_samples = random.sample(self.right_part, self.ng)
                    else:
                        negative_samples = random.sample(self.left_part, self.ng)
                    w_n = []
